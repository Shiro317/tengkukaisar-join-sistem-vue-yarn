...
<template>
  <section class="flex flex-col gap-8 bg-white px-[80px] py-[40px]">
    <div class="flex items-center justify-between gap-6">
      ...
      >
        <img
          src="@/assets/images/misc/listauthor1.png"
          alt="Author 1"
      ...
      <div
        class="w-[296px] bg-x-lightyellow flex flex-col items-center justify-center gap-4 p-6"
      >
        <img
          src="@/assets/images/misc/listauthor2.png"
          alt="Author 2"
          class="w-[128px] h-[128px]"
        />
        <div class="flex flex-col items-center">
      ...
      >
        <img
          src="@/assets/images/misc/listauthor3.png"
          alt="Author 3"
          class="w-[128px] h-[128px]"
        />
        <div class="flex flex-col items-center">
      ...
      >
        <img
          src="@/assets/images/misc/listauthor4.png"
          alt="Author 4"
          class="w-[128px] h-[128px]"
        />
        <div class="flex flex-col items-center">
